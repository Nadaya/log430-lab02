...
if __name__ == "__main__":
    ...
    print("Starting Store Manager application...")

    # Synchroniser Redis avec MySQL si nécessaire
    rows_synced = sync_all_orders_to_redis()
    print(f"Redis synchronization complete. {rows_synced} orders available in Redis.")
